...
interface SlotMachinePhase {
    ...
    object BAIT : SlotMachinePhase {
        ...
        override val scrollItems: List<ScrollItem> = listOf(
            // 小赚
            scroll(Material.COOKED_BEEF, RewardEvent.SimpleItem(Material.COOKED_BEEF, 16)),
            scroll(Material.IRON_INGOT, RewardEvent.SimpleItem(Material.IRON_INGOT, 10)),
            scroll(Material.IRON_CHESTPLATE, RewardEvent.SimpleItem(Material.IRON_CHESTPLATE)),
            scroll(Material.GOLDEN_CARROT, RewardEvent.SimpleItem(Material.GOLDEN_CARROT, 8)),
            scroll(Material.ENCHANTED_BOOK, RewardEvent.SimpleItem(Material.ENCHANTED_BOOK)),
            scroll(Material.GOLDEN_APPLE, RewardEvent.Heal(2.0)),
            // 大赚
            scroll(Material.DIAMOND, RewardEvent.Ticket(1)),
            scroll(Material.DIAMOND_SWORD, RewardEvent.SimpleItem(
                Material.DIAMOND_SWORD,
                enchantments = mapOf(Enchantment.SHARPNESS to 3)
            )),
            scroll(Material.EMERALD, RewardEvent.SimpleItem(Material.EMERALD, 5)),
        )
    ...
    object GREED : SlotMachinePhase {
        ...
        override val scrollItems: List<ScrollItem> = listOf(
            ...
            scroll(Material.NETHERITE_SWORD, RewardEvent.SimpleItem(Material.NETHERITE_SWORD)),
            scroll(Material.ENCHANTED_GOLDEN_APPLE, RewardEvent.SimpleItem(Material.ENCHANTED_GOLDEN_APPLE)),
            scroll(Material.GLISTERING_MELON_SLICE, RewardEvent.Heal(5.0)),
            scroll(Material.GOLDEN_SWORD, RewardEvent.PowerfulItem(
                nameSupplier = { RandomSword.name },
                itemSupplier = { RandomSword.getter }
            )),
            scroll(Material.BOW, RewardEvent.PowerfulItem(
                nameSupplier = { SlotMachineBow.name },
                itemSupplier = { SlotMachineBow.getter }
            )),
            scroll(Material.LEATHER_CHESTPLATE, RewardEvent.PowerfulItem(
    ...
    object ABYSS : SlotMachinePhase {
        ...
        override val scrollItems: List<ScrollItem> = listOf(
            ...
            scroll(Material.ENCHANTED_GOLDEN_APPLE, RewardEvent.SimpleItem(Material.ENCHANTED_GOLDEN_APPLE, count = 2)),
            // 大的来咯
